...
const LatestProduct = ({ data }) => {
  return (
    <div className="max-w-[315px] shadow-shadow flex flex-col p-8 align-middle justify-center items-center relative">
      ...
      <div className="flex flex-col align-middle justify-center items-center basis-2/3 -mt-40">
        ...
        <Button styles="text-white py-[10px] px-[60px] inline-block mt-[30px] bg-green-400">
          Ətraflı
        </Button>
      </div>
    </div>
